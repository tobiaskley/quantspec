...
acf(Y)
spectrum(Y, method="ar", log="no", ylim=c(0, 6e-5))
spectrum(Y, method="pgram", span=75, log="no", ylim=c(0, 6e-5))
...
# use a Epanechnikov kernel and bandwidth of 0.1
sPG <- smoothedPG(CR, weight=kernelWeight(W=W1, bw=0.1))
